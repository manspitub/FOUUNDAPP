...
import { FoundObjectLocation } from 'src/app/interfaces/found-object-location.interface';
...
@Component({
  selector: 'app-found-object-where',
  templateUrl: './found-object-where.component.html',
  styleUrls: ['./found-object-where.component.css']
})
export class FoundObjectWhereComponent implements OnInit {
  ...
  locationObjectLost(){
    ...
    this.lostObjectService.postFoundObjectLocation(this.lat, this.long)
  }
